...
- Pokud má případ v budoucnu **vrátit se k revizi** dle dějové linky, doplni vhodný blok `review_card` dle kuchařky (summary_short, option_a, option_b…). **Nepřidávej** náhodné revize, jen když to dává děj nebo tým v zadání.
