# Dokumentace mechanik — IN DUBIO

Texty pro design, autorování a orientaci v kódu. Kanon detailů zůstává v `.cursor/rules/` (`core.mdc`, `story.mdc`, `cases.mdc`, `economy.mdc`, `traits-factions.mdc`).
